...
@review_router.patch(
    "/update_review", response_model=ReviewResponseModel, status_code=status.HTTP_200_OK
)
async def edit_review():
    pass


@review_router.delete("/delete_review/{}", status_code=status.HTTP_204_NO_CONTENT)
